...
pygame.display.set_caption("The Frosted Bunny")
FPS = 60
...
# Images
hero_img = pygame.image.load("assets/Cubby_bunny.png")
hero_img = pygame.transform.scale(hero_img, (64, 64))

block_img = pygame.image.load("assets/slice03_03.png")
block_img = pygame.transform.scale(block_img, (64, 64))

coin_img = pygame.image.load("assets/Cupcake.png")
...
class Game():
    ...
    def __init__(self, hero, level):
        ...
        #self.main_layer = pygame.Surface([1920, 640], pygame.SRCALPHA, 32)
